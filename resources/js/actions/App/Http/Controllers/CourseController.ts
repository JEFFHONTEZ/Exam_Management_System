...
* @see app/Http/Controllers/CourseController.php:49
* @route '/courses'
*/
...
* @see app/Http/Controllers/CourseController.php:64
...
* @see app/Http/Controllers/CourseController.php:69
...
const CourseController = { index, store, create, edit, update, destroy }
